...
#> {"level":200,"timestamp":"2026-06-03 06:54:34","logger":"dummy logger","caller":null,"msg":"a test message","custom_field":"LayoutJson can handle arbitrary fields"} 
...
lo$format_event(event)
#> {"LEVEL":200,"TIMESTAMP":"2026-06-03 06:54:34","LOGGER":"dummy logger","MSG":"a test message","CUSTOM_FIELD":"LayoutJson can handle arbitrary fields"} 
...
lo$format_event(event)
#> {"level":200,"timestamp":"Wed Jun 03 06:54:34 2026","logger":"dummy logger","caller":null,"msg":"A TEST MESSAGE","rawMsg":"a test message","custom_field":"LayoutJson can handle arbitrary fields"} 
```
