...
#> {"level":200,"timestamp":"2026-06-02 09:59:49","logger":"dummy logger","caller":null,"msg":"a test message","custom_field":"LayoutJson can handle arbitrary fields"} 
...
lo$format_event(event)
#> {"LEVEL":200,"TIMESTAMP":"2026-06-02 09:59:49","LOGGER":"dummy logger","MSG":"a test message","CUSTOM_FIELD":"LayoutJson can handle arbitrary fields"} 
...
lo$format_event(event)
#> {"level":200,"timestamp":"Tue Jun 02 09:59:49 2026","logger":"dummy logger","caller":null,"msg":"A TEST MESSAGE","rawMsg":"a test message","custom_field":"LayoutJson can handle arbitrary fields"} 
```
