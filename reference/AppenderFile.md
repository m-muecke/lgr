...
#> INFO  [09:59:46.298] A test message

readLines(default)
#> [1] "INFO  [2026-06-02 09:59:46.298] A test message"
readLines(fancy)
#> [1] "[2026-06-02 09:59:46.298] eval(): INFO  A test message"
readLines(json)
#> [1] "{\"level\":400,\"timestamp\":\"2026-06-02 09:59:46\",\"logger\":\"test\",\"caller\":\"eval\",\"msg\":\"A test message\"}"
...
lg$appenders[[1]]$show()
#> {"level":400,"timestamp":"2026-06-02 09:59:46","logger":"test","caller":"eval","msg":"A test message"}
#> {"level":400,"timestamp":"2026-06-02 09:59:46","logger":"test","caller":"eval","msg":"A test message with format strings strings","and":"custom_fields"}
lg$appenders[[1]]$data
#>   level           timestamp logger caller
#> 1   400 2026-06-02 09:59:46   test   eval
#> 2   400 2026-06-02 09:59:46   test   eval
#>                                          msg           and
#> 1                             A test message          <NA>
