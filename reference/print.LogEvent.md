...
print(x)
#> WARN  [2026-06-03 06:54:41] a test event
print(x, fmt = c("%t (%p) %c: %n - %m"))
#> 2026-06-03 06:54:41 (6751) testfun(): 300 - a test event
print(x, colors = NULL)
#> WARN  [2026-06-03 06:54:41] a test event
...
print(y)
#> WARN  [2026-06-03 06:54:41] a gps track  {waypoints: `10`, location: `Austria`}
