...
readLines(tf)
#> [1] "INFO  [2026-06-02 10:00:00.434] You must think I am joking"
```
...
readLines(tf)
#> [1] "INFO  [2026-06-02 10:00:00.434] You must think I am joking"
#> [2] "INFO  [June 02 10:00:00] No, I am quite serious"
...
cat(readLines(tf))
#> {"level":400,"timestamp":"2026-06-02 10:00:00","logger":"root","caller":"eval","msg":"We lived in Styria"}
```
...
#> 1   400 2026-06-02 10:00:00   root   eval We lived in Styria
```
...
#> 1   400 2026-06-02 10:00:00   root   eval We lived in Styria            NULL
#> 2   400 2026-06-02 10:00:00   root   eval         Styria has capons, turkeys
...
#> INFO  [2026-06-02 10:00:01] Vampire stories are generally located in Styria
lgr$last_event$values  # all values stored in the event as a list
#> $level
#> [1] 400
#> 
#> $timestamp
#> [1] "2026-06-02 10:00:01 UTC"
#> 
#> $logger
#> [1] "root"
#> 
...
#> 1   400 2026-06-02 10:00:01   root   eval Processing track track.gpx        32
```
...
readLines(tf)
#> [1] "INFO  [2026-06-02 10:00:01.402] Another informational message"                    
#> [2] "DEBUG [2026-06-02 10:00:01.404] A debug message not shown by the console appender"
...
```
    ...
    #> 1   400 2026-06-02 10:00:02   test   eval JSON naturally  custom    NULL <NA>
    #> 2   400 2026-06-02 10:00:02   test   eval supports custom   <NA> 1, 2, 3 <NA>
    #> 3   400 2026-06-02 10:00:02   test   eval      log fields   <NA>    NULL JSON
...
```
    ...
    #> {"level":400,"timestamp":"2026-06-02 10:00:02","logger":"test","caller":"eval","msg":"JSON naturally ","field":"custom"}
    #> {"level":400,"timestamp":"2026-06-02 10:00:02","logger":"test","caller":"eval","msg":"supports custom","numbers":[1,2,3]}
    #> {"level":400,"timestamp":"2026-06-02 10:00:02","logger":"test","caller":"eval","msg":"log fields","use":"JSON"}
...
#> 1 /tmp/Rtmph4BEAs/file1da81f4a4873.1.log file1da81f4a4873   1 log 10608 FALSE
#> 2 /tmp/Rtmph4BEAs/file1da81f4a4873.2.log file1da81f4a4873   2 log 10608 FALSE
#> 3 /tmp/Rtmph4BEAs/file1da81f4a4873.3.log file1da81f4a4873   3 log 10608 FALSE
#> 4 /tmp/Rtmph4BEAs/file1da81f4a4873.4.log file1da81f4a4873   4 log 10608 FALSE
#> 5 /tmp/Rtmph4BEAs/file1da81f4a4873.5.log file1da81f4a4873   5 log 10608 FALSE
#>   mode               mtime               ctime               atime  uid  gid
#> 1  644 2026-06-02 10:00:02 2026-06-02 10:00:02 2026-06-02 10:00:02 1001 1001
#> 2  644 2026-06-02 10:00:02 2026-06-02 10:00:02 2026-06-02 10:00:02 1001 1001
#> 3  644 2026-06-02 10:00:02 2026-06-02 10:00:02 2026-06-02 10:00:02 1001 1001
#> 4  644 2026-06-02 10:00:02 2026-06-02 10:00:02 2026-06-02 10:00:02 1001 1001
#> 5  644 2026-06-02 10:00:02 2026-06-02 10:00:02 2026-06-02 10:00:02 1001 1001
#>    uname grname index
#> 1 runner runner     1
#> 2 runner runner     2
#> 3 runner runner     3
...
#> 
#> appenders:
#>   [[1]]: <AppenderFile> [all] -> /tmp/Rtmph4BEAs/file1da85916ba55
#> 
#> inherited appenders:
#>   console: <AppenderConsole> [info] -> console
```
